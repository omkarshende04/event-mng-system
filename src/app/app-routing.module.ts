...
const routes: Routes = [
  ...
  { path: 'eventregistrationForm', component:EventRegistrationFormComponent},
  { path: 'applyForEvent', component:ApplyForEvent},
  { path: 'registerNewUser', component:RegistrationPageComponent},
  { path: 'carddat', component:CardDataPageComponent},
  { path: 'participents', component: ParticipentsComponent}
];
